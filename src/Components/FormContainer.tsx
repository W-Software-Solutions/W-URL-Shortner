...
const FormContainer: React.FunctionComponent<IFormContainerProps> = (props) => {
  ...
  return(
    <div className='container mx-auto p-2 bg-cyan-700'>
        <div className="bg-[url('https://images.pexels.com/photos/2047905/pexels-photo-2047905.jpeg?auto=compress&cs=tinysrgb&w=600')] my-8 rounded-xl bg-cover bg-center">
