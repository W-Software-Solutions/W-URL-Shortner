                ...
                <form onSubmit={handleSubmit}>
                    <div className="flex">
                        <div className="relative w-full">
                            <div className="w-auto h-full absolute inset-y-0 start-0 flex items-center ps-2 pointer-events-none text-slate-800 hidden sm:block "> urlShortner.link </div>
                            ...
                            <button type='submit' 
                            className='absolute top-0 end-0 p-2.5 text-sm font-medium bg-black h-full sm:w-auto
